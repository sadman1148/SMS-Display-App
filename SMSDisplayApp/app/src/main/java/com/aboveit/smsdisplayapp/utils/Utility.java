...
public class Utility {
    ...
    public static void requestReceivePermission(Activity activity) {
    ...
    public static boolean checkReceivePermission(Context context) {
    ...
    public static String formatTimestamp(long timestampMillis, String pattern) {
